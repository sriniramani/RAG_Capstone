...
An AI-powered assistant built using Retrieval-Augmented Generation (RAG) that provides context-aware answers about California traffic rules and driver rights. It combines semantic search with LLMs for accurate, explainable, and trustworthy responses.
...
@misc{trafficassistant2025,
  title={CA  Rules Assistant using RAG},
  author={Srini R},
  year={2026},
}
```
